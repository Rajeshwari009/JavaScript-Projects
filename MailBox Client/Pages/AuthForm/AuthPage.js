...
const AuthPage = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if(!isLogin)
    {
        url='https://identitytoolkit.googleapis.com/v1/accounts:signUp?key=AIzaSyCpCt9V8M2vEEdeRJT5oKxntIPqmi1dT0U '
    }
    else
    {
        url=' https://identitytoolkit.googleapis.com/v1/accounts:signInWithPassword?key=AIzaSyCpCt9V8M2vEEdeRJT5oKxntIPqmi1dT0U'
    }
    fetch(url,{
        method:'POST',
  ...
  return (
    <div
      ...
      style={{
        minHeight: '100vh',
        backgroundImage: `url(${'https://cdn.pixabay.com/photo/2017/07/01/19/48/background-2462434_1280.jpg'})`,
