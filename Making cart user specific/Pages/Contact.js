...
const Contact = () => {
  ...
  return (
    <div className="container">
      ...
      message={(location)=> "Are you sure you wanna leave? you will lose the existing details."}></Prompt>
      <form className="form" onSubmit={submitHandler} onFocus={formFocusHandler}>
